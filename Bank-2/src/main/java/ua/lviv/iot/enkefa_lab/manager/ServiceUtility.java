...
public class ServiceUtility {
	...
	private static final ServiceSortByInterestRate SERVICE_SORTER_BY_INTEREST_RATE = new ServiceSortByInterestRate();

	private static final ServiceSortByDuration SERVICE_SORTER_BY_DURATION = new ServiceUtility().new ServiceSortByDuration();
	...
	public static void sortServicesByDuration(List<Service> services, SortType sortType) {
		services.sort(
				sortType == SortType.ASCENDING ? SERVICE_SORTER_BY_DURATION : SERVICE_SORTER_BY_DURATION.reversed());
	}
	...
	public static void serviceSortByDurationAndInterestRate(List<Service> services, SortType sortType) {
		Comparator<Service> comparator = new Comparator<Service>() {

			@Override
			public int compare(Service serviceOne, Service serviceTwo) {

				double interestRateComparisonResult = serviceOne.getInterestRate() - serviceTwo.getInterestRate();
	...
	public static void serviceSortByInterestRateLambdaStyle(List<Service> services, SortType sortType) {
